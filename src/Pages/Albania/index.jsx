...
import AlbaniaDetail from '../../assets/svg/Albania-img-1.png'
import Hiring from '../../assets/svg/Albania-img-2.png'
import Team from '../../assets/svg/Albania-img-3.png'
import AlbaniaMain from '../../assets/svg/Albania-main.png'
...
export default function index() {
    return (
        <div>
            <Navbar/>
            <img style={{width:"100%"}} src={AlbaniaMain} alt=""/>
